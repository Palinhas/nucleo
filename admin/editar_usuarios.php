...
<html lang="pt">
  <head>
    ...
    <title>Consula Usuários | Site oficial do Núcleo do Sporting Clube de portugal de Campo Maior</title>
  </head>
  <body class="body"> 
  ...
  <div class="col mb-3" style="flex: 50%; float: left; background: #eeeeee;">
   ...
   <form method="POST" action="proc_edit_usuario.php">
      <div class="form-group col-md-1">
        <label></label>         
        <input type="hidden" class="form-control" name="id" value="<?php echo $row_usuario['id']; ?>"></input>
      </div>
      <div class="form-row">
      ...
      <div class="form-row">
        <div class="form-group col-md-3">
              <label>Nome de Logín</label>
             <input type="text" name="usuario" class="form-control" placeholder="" value="<?php echo $row_usuario['usuario']; ?>">
        </div>
         <div class="form-group col-md-3">
              <label>Contribuinte</label>
              <input type="text" name="nif" class="form-control" placeholder="" value="<?php echo $row_usuario['nif']; ?>">
        </div>
                 <div class="form-group col-md-6">
              <label>E-mail</label>
              <input type="text" name="email" class="form-control" placeholder="" value="<?php echo $row_usuario['email']; ?>">
        </div>
      </div>
        ...
        <div class="modal fade" id="cancelarModal" tabindex="-1" role="dialog" aria-labelledby="cancelarModal" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-danger mb-2" data-dismiss="modal">NÃO</button>
               <a class="btn btn-success btn-sm mb-2" role="button" href="usuarios.php">Sim</a>
              </div>
            </div>
          </div>
        </div>
