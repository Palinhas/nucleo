...
<html lang="pt">
  <head>
    ...
    <title>Consula Sócios | Site oficial do Núcleo do Sporting Clube de portugal de Campo Maior</title>
  </head>
  <body class="body"> 
...
<div class="list-group" style="width: 200px;">
  ...
  <div class="col" style="flex: 50%; float: left; background: #eeeeee;">
    <div class="mt-3">
      <span class="d-block p-3 bg-success text-white">Consultar informação do sócio</span>
    </div>
  ...
  <div class="card-body">
    <form>
      ...
      <div class="form-group col-md-1">
        <label>Arquivo</label>         
        <input disabled class="form-control text-center" name="id" value="<?php echo $row_socio['id']; ?>"></input>
      </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-3">
              <label>Número Sócio do núcleo</label>
              <input disabled class="form-control" value="<?php echo $row_socio['socio']; ?>">
        </div>
         <div class="form-group col-md-3">
              <label>Quotas</label>
              <input disabled class="form-control" value="<?php echo $row_socio['quota']; ?>">
        </div>
        <div class="form-group col-md-3">
              <label>Criado</label>
              <input disabled class="form-control" value="<?php echo $row_socio['created']; ?>">
        </div>
         <div class="form-group col-md-3">
              <label>Modificado</label>
              <input disabled class="form-control" value="<?php echo $row_socio['modified']; ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-9">
              <label>Nome</label>
              <input disabled class="form-control" value="<?php echo $row_socio['nome']; ?>">
        </div>
        <div class="form-group col-md-3">
              <label>Dáta Nascimento</label>
              <input disabled class="form-control" value="<?php echo $row_socio['birth']; ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-12">
              <label>Morada</label>
              <input disabled class="form-control" value="<?php echo $row_socio['morada']; ?>">
        </div>
      </div>
        <div class="form-row">
        <div class="form-group col-md-3">
              <label>Codigo-postal</label>
              <input disabled class="form-control" value="<?php echo $row_socio['cp']; ?>">
        </div>
        <div class="form-group col-md-9">
              <label>Localidade</label>
              <input disabled class="form-control" value="<?php echo $row_socio['localidade']; ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-4">
              <label>Número Cartão de cidadão</label>
              <input disabled class="form-control" value="<?php echo $row_socio['cc']; ?>">
        </div>
          <div class="form-group col-md-4">
              <label>Número Contribuinte</label>
              <input disabled class="form-control" value="<?php echo $row_socio['nif']; ?>">
        </div>
          <div class="form-group col-md-4">
              <label>Ocupação</label>
              <input disabled class="form-control" value="<?php echo $row_socio['ocupacao']; ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-8">
              <label>E-mail</label>
              <input disabled class="form-control" value="<?php echo $row_socio['email']; ?>">
        </div>
          <div class="form-group col-md-4">
              <label>Contacto telefónico</label>
              <input disabled class="form-control" value="<?php echo $row_socio['contacto']; ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
              <label>Número Sócio SCP</label>
              <input disabled class="form-control" value="<?php echo $row_socio['socio_scp']; ?>">
        </div>
          <div class="form-group col-md-6">
              <label>Tipo de Sócio</label>
              <input disabled class="form-control" value="<?php echo $row_socio['tipo_scp']; ?>">
        </div>                                  <!-- Botões -->
      </div><br>
        <div class="col-auto">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <?php // Botões
            echo '<a class="btn btn-sm btn-success mb-2" href="editar_socios.php?id='.$row_socio['id'].'" role="button"> Sim </a>';
              ?>
              </div>
            </div>
          </div>
        ...
        <div class="modal fade" id="cancelarModal" tabindex="-1" role="dialog" aria-labelledby="cancelarModal" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-danger mb-2" data-dismiss="modal">NÃO</button>
               <a class="btn btn-sm btn-success mb-2" role="button" href="socios.php">Sim</a>
              </div>
            </div>
          </div>
        </div>
